...
/**
 * kash_read_line - a function that uses the getline() function from <stdio.h>
 * to read a single line of input from stdin.
 * Return: Always 0 success
 */
...
/**
 * kash_split_line - a function that split the input string
 * into an array of individual tokens.
...
void kash_help(char **args)
{
	...
	char *text = "Kash - the Kinda Aimless Shell. These commands are available:\n"
...
/**
 * kash_num_builtins - a function that handles the command name
 * and its handler function, that is the builtin commands
 * Return: always 0 success
*/
